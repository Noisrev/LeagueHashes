...
{
    public class CCITT32ViewModel : HashBaseViewModel<string, long>
    {
        private readonly uint[] CRC_LOOKUP = new uint[]{
        ...
        public override void ComputedHash()
        {
            ...
            for (int i = 0; i < buffer.Length; i++)
            {
                ...
                long crcLookupIndex = (((crc >> 24) & 0xFF) ^ value);
        ...
        public override void Submit(string key, long value)
        {
            ...
            OnChangedText();
            HistoryHelper.AddHistory(new Core.Models.HistoryEntry(Core.Models.HistoryType.CCITT32, $"{key} {(IsHex ? Output_Hex : Output_Dec)}"));
        }
    }
}
